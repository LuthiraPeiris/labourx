        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-gold/20 border border-gold/40 rounded-full px-4 py-1.5 mb-5">
              ...
              <span className="text-gold text-sm" style={{ fontWeight: 500 }}>
                Sri Lanka&apos;s #1 Construction Marketplace
              </span>
            </div>

            <h1
              className="text-white mb-4"
              style={{ fontSize: '2.75rem', fontWeight: 700, lineHeight: 1.2 }}
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground">
              Find the right professional for every construction need
            </p>
          </div>
          ...
          <div className="text-center mt-6">
            <Link
              to="/search"
              className="inline-flex items-center gap-2 text-maroon hover:text-maroon-dark text-sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {steps.map((step, i) => (
              <div key={i} className="relative">
                {i < steps.length - 1 && (
                  <div
                    className="hidden md:block absolute top-10 left-full w-full h-px border-t-2 border-dashed border-maroon/30 z-0 -translate-y-px"
                    style={{ width: 'calc(100% - 3rem)', left: '75%' }}
                  />
                )}
                ...
                <div className="bg-card border border-border rounded-xl p-6 relative z-10">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div
                      className="w-7 h-7 rounded-full bg-gold text-white flex items-center justify-center text-sm"
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Highly rated and verified experts
              </p>
            </div>

            <Link
              to="/search"
              className="flex items-center gap-1 text-maroon hover:text-maroon-dark text-sm"
              style={{ fontWeight: 500 }}
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Open projects looking for skilled professionals
              </p>
            </div>
